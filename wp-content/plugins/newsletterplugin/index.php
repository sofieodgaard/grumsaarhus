...
* Version: 0.1.0
* Author: Sofie Odgaard
* Author URI: https://www.sofieodgaard.dk/grumsaarhus/
* License: GPL2
*/
...
function newsletter_form()
{
    ...
    function register_styles_and_scripts_for_plugin() 
    {
        ...
        wp_enqueue_script('CostumScript',plugins_url('newsletterplugin/js/script.js'),array(),null,'true');
    }
