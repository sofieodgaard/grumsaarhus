...
function newsletter_form(){
    ...
    function register_style_and_scripts_for_plugin()
    {
        ...
        wp_enqueue_style('Custom_Stylesheet',plugins_url('/grumspakke-popup-plugin/css/style.css'));
        wp_deregister_script('jquery');
        wp_enqueue_script('jquery','https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js',array(), null, true);
        wp_enqueue_script('CustomJavaScript',plugins_url('/grumspakke-popup-plugin/js/script.js'), array('jquery'), null, true);
    }
  ...
  # {
	...
	#	wp_enqueue_script('CustomScript', plugins_url('/grumspakke-popup-plugin/js/script.js'), array('jquery'), null, true);
